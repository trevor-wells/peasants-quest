...
# session.bulk_save_objects(my_player, cave_outside, cave_inside, orchard, spring_outside, spring_inside, grove, tavern_outside, tavern_inside, castle_outside, castle_inside, lake, dock, home_outside, home_inside)
session.commit()
session.close()